...
import AiSummaryCard from "../maintenance/AiSummaryCard";
  ...
  const statCards = [
    {
      ...
      value: loading ? "..." : stats?.assignedTasks.toString() || "0",
      color: "#1976d2",
    },
    {
  ...
  return (
    <Box>
      ...
      {assignedTasks.length === 0 ? (
        <Alert severity="info">
          No tasks currently assigned. All caught up!
        </Alert>
      ) : (
              ...
              <CardContent>
                ...
                >
                  <Typography variant="h6">
                    {task.facility.name} - {task.description.substring(0, 50)}
                    ...
                  </Typography>
                  <Chip
